...
TOOLSETS = {
    ...
    "hermes-max": {
        "description": "MAX bot toolset - MAX messenger via Bot API (full access)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "hermes-gateway": {
        ...
        "tools": [],
        "includes": ["hermes-telegram", "hermes-discord", "hermes-whatsapp", "hermes-slack", "hermes-signal", "hermes-bluebubbles", "hermes-homeassistant", "hermes-email", "hermes-sms", "hermes-mattermost", "hermes-matrix", "hermes-dingtalk", "hermes-feishu", "hermes-wecom", "hermes-wecom-callback", "hermes-weixin", "hermes-qqbot", "hermes-max", "hermes-webhook"]
    }
}
