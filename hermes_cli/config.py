...
_EXTRA_ENV_KEYS = frozenset({
    ...
    "MAX_BOT_TOKEN", "MAX_BASE_URL", "MAX_BOT_USER_ID", "MAX_BOT_USERNAME",
...
OPTIONAL_ENV_VARS = {
    ...
    "MAX_BOT_TOKEN": {
        "description": "MAX Bot API token. Sent via Authorization header to platform-api.max.ru",
    ...
    "MAX_ALLOWED_USERS": {
        "description": "Comma-separated MAX user IDs allowed to use the bot",
        "prompt": "MAX Allowed Users",
        "category": "messaging",
    },
    "MAX_GROUP_ALLOWED_USERS": {
        "description": "Comma-separated MAX chat/channel IDs allowed to interact with the bot",
        "prompt": "MAX Group Allowed Users",
        "category": "messaging",
    },
    "MAX_ALLOW_ALL_USERS": {
        "description": "Allow all MAX users without an allowlist (true/false)",
        "prompt": "Allow All MAX Users",
        "category": "messaging",
    },
    "MAX_HOME_CHANNEL": {
        "description": "Default MAX chat/user target for cron delivery and notifications. Use chat:<id> or user:<id> when ambiguous.",
        "prompt": "MAX Home Channel",
        "category": "messaging",
    },
    "MAX_HOME_CHANNEL_NAME": {
        "description": "Display name for the MAX home channel",
        "prompt": "MAX Home Channel Name",
        "category": "messaging",
    },
    "MAX_BASE_URL": {
        "description": "MAX Bot API base URL (default: https://platform-api.max.ru)",
        "prompt": "MAX API Base URL",
        "category": "messaging",
        "advanced": True,
    },
    "MAX_WEBHOOK_PUBLIC_URL": {
        "description": "Public HTTPS MAX webhook URL, without an explicit port (MAX delivers on 443)",
        "prompt": "MAX Webhook Public URL",
        "category": "messaging",
    },
    "MAX_WEBHOOK_SECRET": {
        "description": "MAX webhook secret validated from X-Max-Bot-Api-Secret (5-256 chars: A-Z, a-z, 0-9, underscore, hyphen)",
        "prompt": "MAX Webhook Secret",
        "password": True,
        "category": "messaging",
    },
    "MAX_WEBHOOK_HOST": {
        "description": "Local host/interface for the MAX webhook receiver (default: 127.0.0.1)",
        "prompt": "MAX Webhook Host",
        "category": "messaging",
        "advanced": True,
    },
    "MAX_WEBHOOK_PORT": {
        "description": "Local port for the MAX webhook receiver behind your HTTPS reverse proxy (default: 8647)",
        "prompt": "MAX Webhook Port",
        "category": "messaging",
        "advanced": True,
    },
    "MAX_WEBHOOK_PATH": {
        "description": "Local path for the MAX webhook receiver (default: /max-webhook)",
        "prompt": "MAX Webhook Path",
        "category": "messaging",
        "advanced": True,
    },
    "MAX_UPDATE_TYPES": {
        "description": "Comma-separated MAX update types for webhook subscription (default: message_created,bot_started)",
        "prompt": "MAX Update Types",
        "category": "messaging",
        "advanced": True,
    },
    "MAX_AUTO_SUBSCRIBE": {
        "description": "Automatically POST /subscriptions at gateway startup when MAX_WEBHOOK_PUBLIC_URL is configured (true/false)",
        "prompt": "MAX Auto Subscribe",
        "category": "messaging",
        "advanced": True,
    },
    "MAX_TRANSPORT": {
