...
_PLATFORMS = [
    ...
    },
    {
        ...
        "setup_instructions": [
            ...
            "4. Production mode: configure an HTTPS webhook endpoint on port 443; MAX recommends Webhook",
            "5. Local test mode: set MAX_TRANSPORT=polling to use GET /updates without a public URL",
            "6. Hermes can auto-create POST /subscriptions when MAX_WEBHOOK_PUBLIC_URL is set",
        ],
        "vars": [
            ...
            {"name": "MAX_TRANSPORT", "prompt": "Transport (webhook for production, polling for local test)", "password": False,
             "help": "Default is webhook. Use polling only for local development/testing without a public HTTPS URL."},
