...
def _would_warn():
    ...
    _any_allowlist = any(
        ...
        for v in ("TELEGRAM_ALLOWED_USERS", "DISCORD_ALLOWED_USERS",
                   ...
                   "MAX_ALLOWED_USERS", "MAX_GROUP_ALLOWED_USERS",
...
class TestAllowlistStartupCheck:
    ...
    def test_max_allowed_users_suppresses_warning(self):
        with patch.dict(os.environ, {"MAX_ALLOWED_USERS": "123"}, clear=True):
            assert _would_warn() is False

    def test_max_allow_all_users_suppresses_warning(self):
        with patch.dict(os.environ, {"MAX_ALLOW_ALL_USERS": "true"}, clear=True):
            assert _would_warn() is False
