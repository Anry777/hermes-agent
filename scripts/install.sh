...
# Configuration
REPO_URL_SSH="git@github.com:Anry777/hermes-agent.git"
REPO_URL_HTTPS="https://github.com/Anry777/hermes-agent.git"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  irm https://raw.githubusercontent.com/Anry777/hermes-agent/prod/scripts/install.ps1 | iex"
            exit 1
            ;;
        *)
            OS="unknown"
